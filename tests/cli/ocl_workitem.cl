// RUN: rm -rf %t.kcache && env POCL_CACHE_DIR=%t.kcache POCL_CPU_MAX_CU_COUNT=1 POCL_CPU_NUM_WORKERS=1 %ocldbg -b -o "ocl break ocl_workitem.cl:12" -o "run" -o "ocl wi list" -o "ocl select 0" -o "ocl p gid" -o "ocl p val" -o "ocl select 3" -o "ocl wi list" -o "ocl p gid" -o "ocl p val" -o "c" -o "ocl wi list" -o "ocl select 1" -o "ocl p acc" -o "ocl break delete 1" -o "c" %test_host_runner %s reduce_sum | %FileCheck %s
